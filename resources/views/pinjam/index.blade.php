                ...
                <div class="card-body">
                    <form action="{{ route('pinjam.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('unit_bagian') is-invalid @enderror" 
                                id="unit_bagian" name="unit_bagian" required>
                                <option value="">Pilih Unit/Bagian...</option>
                                <option value="akademik" {{ old('unit_bagian') == 'akademik' ? 'selected' : '' }}>Akademik</option>
                                <option value="keuangan" {{ old('unit_bagian') == 'keuangan' ? 'selected' : '' }}>Keuangan</option>
                                <option value="kemahasiswaan" {{ old('unit_bagian') == 'kemahasiswaan' ? 'selected' : '' }}>Kemahasiswaan</option>
                                <option value="umum" {{ old('unit_bagian') == 'umum' ? 'selected' : '' }}>Umum</option>
                                <option value="lainnya" {{ old('unit_bagian') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                            </select>
                            @error('unit_bagian')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_pinjam') is-invalid @enderror" 
                                id="tanggal_pinjam" name="tanggal_pinjam" required value="{{ old('tanggal_pinjam', date('Y-m-d')) }}"
                                autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_kembali') is-invalid @enderror" 
                                id="tanggal_kembali" name="tanggal_kembali" required value="{{ old('tanggal_kembali') }}"
                                autocomplete="off">
